...
public class GamePanel extends JPanel implements ActionListener{
    ...
    static final int DELAY =75; // Higher thwe number, slower the game.
    static final int x[]= new int[GAME_UNITS]; // Hold coordinates for the all body part pf snake
    static final int y[]= new int[GAME_UNITS];
    int bodyParts = 6; // initial body parts
    int applesEaten =0;
    int appleX;
    int appleY;
    char direction = 'R'; // DIRECTION OF SNAKE - R(RIGHT),D(DOWN, L(LEFT),U(UP)).
